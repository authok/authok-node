...
describe('LogStreamsManager', () => {
  ...
  describe('#getAll', () => {
    ...
    it('should perform a GET request to /api/v1/log-streams', function (done) {
      const { request } = this;
  ...
  describe('#get', () => {
    ...
    it('should perform a GET request to /api/v1/log-streams/:id', function (done) {
      const { request } = this;
  ...
  describe('#create', () => {
    ...
    it('should perform a POST request to /api/v1/log-streams', function (done) {
      const { request } = this;
  ...
  describe('#update', () => {
    ...
    it('should perform a PATCH request to /api/v1/log-streams/5', function (done) {
      const { request } = this;
