...
const API_URL = 'https://tenant.authok.com';
...
describe('OrganizationsManager', () => {
  ...
  describe('#getAll', () => {
    ...
    it('should perform a GET request to /api/v1/organizations', function (done) {
      const { request } = this;
  ...
  describe('#getByID', () => {
    ...
    it('should perform a GET request to /api/v1/organizations/:id', function (done) {
      const { request } = this;
  ...
  describe('#getByName', () => {
    ...
    it('should perform a GET request to /api/v1/organizations/name/:name', function (done) {
      const { request } = this;
  ...
  describe('#create', () => {
    ...
    it('should perform a POST request to /api/v1/organizations', function (done) {
      const { request } = this;
  ...
  describe('#update', () => {
    ...
    it('should perform a PATCH request to /api/v1/organizations/org_123', function (done) {
      const { request } = this;
  ...
  describe('#getEnabledConnections', () => {
    ...
    it('should perform a GET request to /api/v1/organizations/org_id/enabled_connections', function (done) {
      const { request } = this;
  ...
  describe('#getEnabledConnection', () => {
    ...
    it('should perform a GET request to /api/v1/organizations/rol_ID/enabled_connections/con_id', function (done) {
      const { request } = this;
  ...
  describe('#addEnabledConnection', () => {
    ...
    it('should perform a POST request to /api/v1/organizations/org_id/enabled_connections', function (done) {
      const { request } = this;
  ...
  describe('#updateEnabledConnection', () => {
    ...
    it('should perform a PATCH request to /api/v1/organizations/org_id/enabled_connections/conn_id', function (done) {
      const { request } = this;
  ...
  describe('#removeEnabledConnection', () => {
    ...
    it('should perform a DELETE request to /api/v1/organizations/organization_id/enabled_connections/connection_id', function (done) {
      const { request } = this;
  ...
  describe('#getMembers', () => {
    ...
    it('should perform a GET request to /api/v1/organizations/org_ID/members', function (done) {
      const { request } = this;
  ...
  describe('#addMembers', () => {
    ...
    it('should perform a POST request to /api/v1/organizations/org_id/members', function (done) {
      const { request } = this;
  ...
  describe('#removeMembers', () => {
    ...
    it('should perform a DELETE request to /api/v1/organizations/organization_id/members', function (done) {
      const request = nock(API_URL)
  ...
  describe('#getMemberRoles', () => {
    ...
    it('should perform a GET request to /api/v1/organizations/org_ID/members/user_id/roles', function (done) {
      const { request } = this;
  ...
  describe('#addMemberRoles', () => {
    ...
    it('should perform a POST request to /api/v1/organizations/org_id/members/user_id/roles', function (done) {
      const { request } = this;
  ...
  describe('#removeMemberRoles', () => {
    ...
    it('should perform a DELETE request to /api/v1/organizations/organization_id/members/user_id/roles', function (done) {
      const request = nock(API_URL)
  ...
  describe('#getInvitations', () => {
    ...
    it('should perform a GET request to /api/v1/organizations/org_ID/invitations', function (done) {
      const { request } = this;
  ...
  describe('#getInvitation', () => {
    ...
    it('should perform a GET request to /api/v1/organizations/rol_ID/invitations/inv_id', function (done) {
      const { request } = this;
  ...
  describe('#createInvitation', () => {
    ...
    it('should perform a POST request to /api/v1/organizations/org_id/invitations', function (done) {
      const { request } = this;
  ...
  describe('#deleteInvitation', () => {
    ...
    it('should perform a DELETE request to /api/v1/organizations/organization_id/invitations/inv_id', function (done) {
      nock.cleanAll();
