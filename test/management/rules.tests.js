...
describe('RulesManager', () => {
  ...
  describe('#getAll', () => {
    ...
    it('should perform a GET request to /api/v1/rules', async function () {
      const { request } = this;
  ...
  describe('#get', () => {
    ...
    it('should perform a POST request to /api/v1/rules/5', async function () {
      const { request } = this;
  ...
  describe('#create', () => {
    ...
    it('should perform a POST request to /api/v1/rules', async function () {
      const { request } = this;
  ...
  describe('#update', () => {
    ...
    it('should perform a PATCH request to /api/v1/rules/5', async function () {
      const { request } = this;
