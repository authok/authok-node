...
const API_URL = 'https://tenants.authok.com';
...
describe('GuardianManager', () => {
  ...
  describe('#getGuardianEnrollment', () => {
    ...
    it('should perform a GET request to /api/v1/guardian/enrollments', function (done) {
      const { request } = this;
  ...
  describe('#createEnrollmentTicket', () => {
    ...
    it('should perform a POST request to /api/v1/guardian/enrollments/ticket', function (done) {
      const { request } = this;
  ...
  describe('#getFactors', () => {
    ...
    it('should perform a GET request to /api/v1/guardian/factors', function (done) {
      const { request } = this;
  ...
  describe('#getFactorSettings', () => {
    ...
    it('should perform a GET request to /api/v1/guardian/factors/webauthn-roaming/settings', function (done) {
      const { request } = this;
  ...
  describe('#getFactorProvider', () => {
    ...
    it('should perform a GET request to /api/v1/guardian/factors/sms/twilio', function (done) {
      const { request } = this;
  ...
  describe('#updateFactorProvider', () => {
    ...
    it('should perform a PUT request to /api/v1/guardian/factors/sms/providers/twilio', function (done) {
      const request = nock(API_URL)
  ...
  describe('#getFactorTemplates', () => {
    ...
    it('should perform a GET request to /api/v1/guardian/factors/sms/templates', function (done) {
      const { request } = this;
  ...
  describe('#updateFactorTemplates', () => {
    ...
    it('should perform a PUT request to /api/v1/guardian/factors/sms/templates', function (done) {
      const request = nock(API_URL)
  ...
  describe('#updateFactor', () => {
    ...
    it('should perform a PUT request to /api/v1/guardian/factors/sms', function (done) {
      const request = nock(API_URL)
  ...
  describe('#updateFactorSettings', () => {
    ...
    it('should perform a PUT request to /api/v1/guardian/factors/webauthn-roaming/settings', function (done) {
      const request = nock(API_URL)
  ...
  describe('#getPolicies', () => {
    ...
    it('should perform a GET request to /api/v1/guardian/policies', function (done) {
      const { request } = this;
  ...
  describe('#updatePolicies', () => {
    ...
    it('should perform a PUT request to /api/v1/guardian/policies', function (done) {
  ...
  describe('#getPhoneFactorSelectedProvider', () => {
    ...
    it('should perform a GET request to /api/v1/guardian/factors/sms/selected-provider', function (done) {
      const { request } = this;
  ...
  describe('#updatePhoneFactorSelectedProvider', () => {
    ...
    it('should perform a PUT request to /api/v1/guardian/factors/sms/selected-provider', function (done) {
      const request = nock(API_URL)
  ...
  describe('#getPhoneFactorMessageTypes', () => {
    ...
    it('should perform a GET request to /api/v1/guardian/factors/phone/message-types', function (done) {
      const { request } = this;
  ...
  describe('#updatePhoneFactorMessageTypes', () => {
    ...
    it('should perform a PUT request to /api/v1/guardian/factors/phone/message-types', function (done) {
      const request = nock(API_URL)
