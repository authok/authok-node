...
describe('CustomDomainsManager', () => {
  ...
  describe('#getAll', () => {
    ...
    it('should perform a GET request to /api/v1/custom-domains', function (done) {
      const { request } = this;
  ...
  describe('#get', () => {
      ...
      this.data = [
        {
          ...
          origin_domain_name: 'mycompany_cd_0000000000000001.edge.tenants.authok.com',
          verification: {
            methods: ['object'],
          },
        },
    ...
    it('should perform a POST request to /api/v1/custom-domains/cd_0000000000000001', function (done) {
      const { request } = this;
  ...
  describe('#create', () => {
    ...
    it('should perform a POST request to /api/v1/custom-domains', function (done) {
      const { request } = this;
  ...
  describe('#verify', () => {
    ...
    it('should perform a POST request to /api/v1/custom-domains/cd_0000000000000001/verify', function (done) {
      const { request } = this;
