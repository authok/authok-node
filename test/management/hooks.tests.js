...
describe('HookManager', () => {
  ...
  describe('#getAll', () => {
    ...
    it('should perform a GET request to /api/v1/hooks', function (done) {
      const { request } = this;
  ...
  describe('#get', () => {
    ...
    it('should perform a POST request to /api/v1/hooks/5', function (done) {
      const { request } = this;
  ...
  describe('#create', () => {
    ...
    it('should perform a POST request to /api/v1/hooks', function (done) {
      const { request } = this;
  ...
  describe('#update', () => {
    ...
    it('should perform a PATCH request to /api/v1/hooks/5', function (done) {
      const { request } = this;
  ...
  describe('#getSecrets', () => {
    ...
    it('should perform a GET request to /api/v1/hooks/hook_id/secrets', function (done) {
      const { request } = this;
  ...
  describe('#addSecrets', () => {
    ...
    it('should perform a POST request to /api/v1/hooks/hook_id/secrets', function (done) {
      const { request } = this;
  ...
  describe('#removeSecrets', () => {
    ...
    it('should perform a DELETE request to /api/v1/hooks/hook_id/secrets', function (done) {
