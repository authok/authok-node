...
describe('PromptsManager', () => {
  ...
  describe('#getSettings', () => {
    ...
    it('should perform a GET request to /api/v1/prompts', function (done) {
      const { request } = this;
  ...
  describe('#updateSettings', () => {
    ...
    it('should perform a PATCH request to /api/v1/prompts', function (done) {
      const { request } = this;
  ...
  describe('#getCustomTextByLanguage', () => {
    ...
    it('should perform a GET request to /api/v1/prompts/test/custom-text/english', function (done) {
      const { request } = this;
  ...
  describe('#updateCustomTextByLanguage', () => {
    ...
    it('should perform a PUT request to /api/v1/prompts/test/custom-text/english', function (done) {
      const { request } = this;
