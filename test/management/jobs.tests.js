...
describe('JobsManager', () => {
  ...
  describe('#get', () => {
    ...
    it('should perform a GET request to /api/v1/jobs', function (done) {
      const { request } = this;
  ...
  describe('#errors', () => {
    ...
    it('should perform a GET request to /api/v1/jobs/:id/errors', function (done) {
      const { request } = this;
  ...
  describe('#importUsers', () => {
    ...
    it('should pass HTTP errors to the promise catch handler', function (done) {
      ...
      this.jobs.importUsers(data).catch((err) => {
        expect(err.message).to.equal(
          'cannot POST https://tenant.authok.com/jobs/users-imports (500)'
        );
        done();
      });
    });
    ...
    it('should pass rest-api json error messages to the promise catch handler', function (done) {
      ...
      this.jobs.importUsers(data).catch((err) => {
        expect(err.message).to.equal(
          'cannot POST https://tenant.authok.com/jobs/users-imports (429)'
        );
    ...
    it('should perform a POST request to /api/v1/jobs/users-imports', function (done) {
      const { request } = this;
  ...
  describe('#exportUsers', () => {
    ...
    it('should perform a POST request to /api/v1/jobs/users-exports', function (done) {
      const { request } = this;
  ...
  describe('#verifyEmail', () => {
    ...
    it('should perform a POST request to /api/v1/jobs/verification-email', function (done) {
      const { request } = this;
