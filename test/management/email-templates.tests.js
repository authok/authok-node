...
describe('EmailTemplatesManager', () => {
  ...
  describe('#get', () => {
    ...
    it(`should perform a GET request to /api/v1/email-templates/${TEMPLATE_NAME}`, function (done) {
      const { request } = this;
  ...
  describe('#create', () => {
    ...
    it('should perform a POST request to /api/v1/email-templates', function (done) {
      const { request } = this;
  ...
  describe('#update', () => {
    ...
    it(`should perform a PATCH request to /api/v1/email-templates/${TEMPLATE_NAME}`, function (done) {
      const { request } = this;
