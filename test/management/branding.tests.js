...
describe('BrandingManager', () => {
  ...
  describe('#getSettings', () => {
    ...
    it('should perform a GET request to /api/v1/branding', function (done) {
      const { request } = this;
  ...
  describe('#updateSettings', () => {
    ...
    it('should perform a PATCH request to /api/v1/branding', function (done) {
      const { request } = this;
  ...
  describe('#setUniversalLoginTemplate', () => {
    ...
    it('should perform a PUT request to /api/v1/branding/templates/universal-login', function (done) {
      const { request } = this;
  ...
  describe('#deleteUniversalLoginTemplate', () => {
    ...
    it('should perform a DELETE request to /api/v1/branding/templates/universal-login', function (done) {
      const { request } = this;
