...
describe('UsersManager', () => {
  ...
  describe('#getAll', () => {
    ...
    it('should perform a GET request to /api/v1/users', async () => {
      await usersManager.getAll();
  ...
  describe('#getByEmail', () => {
    ...
    it('should perform a GET request to /api/v1/users-by-email', async () => {
      await usersManager.getByEmail();
      expect(scope.isDone()).to.be.true;
    });
  ...
  describe('#get', () => {
    ...
    it('should perform a POST request to /api/v1/users/5', async () => {
  ...
  describe('#create', () => {
    ...
    it('should perform a POST request to /api/v1/users', async () => {
      await usersManager.create(data);
      expect(scope.isDone()).to.be.true;
    });
  ...
  describe('#update', () => {
    ...
    it('should perform a PATCH request to /api/v1/users/5', async () => {
  ...
  describe('#getGuardianEnrollments', () => {
    ...
    it('should perform a GET request to /api/v1/users/5/enrollments', async () => {
  ...
  describe('#regenerateRecoveryCode', () => {
    ...
    it('should perform a POST request to /api/v1/users/:id/recovery-code-regeneration', async () => {
      await usersManager.regenerateRecoveryCode(data);
      expect(scope.isDone()).to.be.true;
    });
  ...
  describe('#invalidateRememberBrowser', () => {
    ...
    it('should perform a POST request to /api/v1/users/:id/multifactor/actions/invalidate-remember-browser', async () => {
      await usersManager.invalidateRememberBrowser(data);
      expect(scope.isDone()).to.be.true;
    });
  ...
  describe('#getRoles', () => {
    ...
    it('should perform a GET request to /api/v1/users/user_id/roles', async () => {
  ...
  describe('#assignRoles', () => {
    ...
    it('should perform a POST request to /api/v1/users/user_id/roles', async () => {
  ...
  describe('#removeRoles', () => {
    ...
    it('should perform a DELETE request to /api/v1/users/user_id/roles', async () => {
      await usersManager.removeRoles(data, {});
      expect(scope.isDone()).to.be.true;
    });
  ...
  describe('#getPermissions', () => {
    ...
    it('should perform a GET request to /api/v1/users/user_id/permissions', async () => {
  ...
  describe('#assignPermissions', () => {
    ...
    it('should perform a POST request to /api/v1/users/user_id/permissions', async () => {
      await usersManager.assignPermissions(data, {});
      expect(scope.isDone()).to.be.true;
    });
  ...
  describe('#removePermissions', () => {
    ...
    it('should perform a DELETE request to /api/v1/users/user_id/permissions', async () => {
      await usersManager.removePermissions(data, {});
      expect(scope.isDone()).to.be.true;
    });
  ...
  describe('#getUserOrganizations', () => {
    ...
    it('should perform a GET request to /api/v1/users/user_id/organizations', async () => {
