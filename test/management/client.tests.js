...
describe('ClientsManager', () => {
  ...
  describe('#getAll', () => {
    ...
    it('should perform a GET request to /api/v1/clients', function (done) {
      const { request } = this;
  ...
  describe('#create', () => {
    ...
    it('should perform a POST request to /api/v1/clients', function (done) {
      const { request } = this;
  ...
  describe('#get', () => {
    ...
    it('should perform a POST request to /api/v1/clients/5', function (done) {
      const { request } = this;
  ...
  describe('#update', () => {
    ...
    it('should perform a PATCH request to /api/v1/clients/5', function (done) {
      const { request } = this;
