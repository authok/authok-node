...
describe('EmailProviderManager', () => {
  ...
  describe('#get', () => {
    ...
    it('should perform a GET request to /api/v1/emails/provider', function (done) {
      const { request } = this;
  ...
  describe('#configure', () => {
    ...
    it('should perform a POST request to /api/v1/emails/provider', function (done) {
      const { request } = this;
  ...
  describe('#update', () => {
    ...
    it('should perform a PATCH request to /api/v1/emails/provider', function (done) {
      const { request } = this;
