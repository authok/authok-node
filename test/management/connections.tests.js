...
describe('ConnectionsManager', () => {
  ...
  describe('#getAll', () => {
    ...
    it('should perform a GET request to /api/v1/connections', function (done) {
      const { request } = this;
  ...
  describe('#get', () => {
    ...
    it('should perform a GET request to /api/v1/connections/:id', function (done) {
      const { request } = this;
  ...
  describe('#create', () => {
    ...
    it('should perform a POST request to /api/v1/connections', function (done) {
      const { request } = this;
  ...
  describe('#update', () => {
    ...
    it('should perform a PATCH request to /api/v1/connections/:id', function (done) {
      const { request } = this;
