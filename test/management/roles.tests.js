...
describe('RolesManager', () => {
  ...
  describe('#getAll', () => {
    ...
    it('should perform a GET request to /api/v1/roles', async function () {
      const { request } = this;
  ...
  describe('#get', () => {
    ...
    it('should perform a POST request to /api/v1/roles/rol_ID', async function () {
      const { request } = this;
  ...
  describe('#create', () => {
    ...
    it('should perform a POST request to /api/v1/roles', async function () {
      const { request } = this;
  ...
  describe('#update', () => {
    ...
    it('should perform a PATCH request to /api/v1/roles/rol_ID', function (done) {
      const { request } = this;
  ...
  describe('#getPermissions', () => {
    ...
    it('should perform a GET request to /api/v1/roles/rol_ID/permissions', async function () {
      const { request } = this;
  ...
  describe('#addPermissions', () => {
    ...
    it('should perform a POST request to /api/v1/roles/rol_ID/permissions', async function () {
      const { request } = this;
  ...
  describe('#removePermissions', () => {
    ...
    it('should perform a DELETE request to /api/v1/roles/rol_ID/permissions', function (done) {
      const { request } = this;
  ...
  describe('#getUsers', () => {
    ...
    it('should perform a GET request to /api/v1/roles/rol_Id/users', function (done) {
      const { request } = this;
  ...
  describe('#assignUsers', () => {
    ...
    it('should perform a POST request to /api/v1/roles/rol_ID/users', function (done) {
      const { request } = this;
    ...
    it('should perform a POST request to /api/v1/roles/rol_ID/users with a callback', function (done) {
      const { request } = this;
