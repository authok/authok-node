...
describe('AttackProtectionManager', () => {
  ...
  describe('Brute Force Protection', () => {
    ...
    describe('#getBruteForceConfig', () => {
      ...
      it(`should perform a GET request to /api/v1${bruteForcePath}`, function (done) {
        const { request } = this;
    ...
    describe('#updateBruteForceConfig', () => {
      ...
      it(`should perform a PATCH request to /api/v1${bruteForcePath}`, function (done) {
        const { request } = this;
  ...
  describe('Suspicious IP Throttling', () => {
    ...
    describe('#getSuspiciousIpThrottlingConfig', () => {
      ...
      it(`should perform a GET request to /api/v1${suspiciousIpPath}`, function (done) {
        const { request } = this;
    ...
    describe('#updateSuspiciousIpThrottlingConfig', () => {
      ...
      it(`should perform a PATCH request to /api/v1${suspiciousIpPath}`, function (done) {
        const { request } = this;
  ...
  describe('Breached Password Detection', () => {
    ...
    describe('#getBreachedPasswordDetectionConfig', () => {
      ...
      it(`should perform a GET request to /api/v1${breachedPasswordDetectionPath}`, function (done) {
        const { request } = this;
    ...
    describe('#updateBreachedPasswordDetectionConfig', () => {
      ...
      it(`should perform a PATCH request to /api/v1${breachedPasswordDetectionPath}`, function (done) {
        const { request } = this;
