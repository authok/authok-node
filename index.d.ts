// Type definitions for authok 2.35
// Project: https://github.com/authok/authok-node
...
export interface Client {
    ...
    /**
     * The URLs that Authok can use to as a callback for the client.
     */
    ...
    /**
     * Url of the location in your site where the cross origin verification takes place for the cross-origin auth flow when performing Auth in your own domain instead of Authok hosted login page.
     */
...
export type CustomDomainType = 'authok_managed_certs' | 'self_managed_certs';
...
/**
 * @see {https://authok.cn/docs/authenticate/passwordless/implement-login/embedded-login/relevant-api-endpoints#post-oauth-token}
 */
...
/** https://authok.com/docs/deploy-monitor/logs/log-event-type-codes */
...
export class ManagementClient<A = AppMetadata, U = UserMetadata> {
    ...
    // Should be removed from authok also. Doesn't exist in api.
    ...
    // The lowercase 't' is like this in the authok sdk
