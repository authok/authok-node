...
class LogStreamsManager {
  ...
  constructor(options) {
     ...
     * {@link https://docs.authok.cn/api/management/v1#!/Log_Streams Authok
     *  Log Streams}.
     *
