...
/**
 * {@link https://docs.authok.cn/api/v1#!/Actions/get_actions Actions} provide a way to extend
 * Authok flows with custom logic.
 * See the {@link https://authok.cn/docs/actions Actions documentation} for more information.
 */
class ActionsManager {
  ...
  constructor(options) {
     ...
     * [Authok Actions endpoint]{@link https://docs.authok.cn/api/v1#!/actions}.
     *
    ...
    const actionsDeployRestClient = new AuthokRestClient(
    ...
    const actionsTestRestClient = new AuthokRestClient(
    ...
    const triggersRestClient = new AuthokRestClient(
    ...
    const triggerBindingsRestClient = new AuthokRestClient(
    ...
    const executionsRestClient = new AuthokRestClient(
    ...
    const actionVersionRestClient = new AuthokRestClient(
    ...
    const deployActionVersionRestClient = new AuthokRestClient(
