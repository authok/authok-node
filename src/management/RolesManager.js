...
class RolesManager {
  ...
  constructor(options) {
     ...
     * {@link https://docs.authok.cn/api/v1#!/RolesManager Authok RolesManagers}.
     *
    ...
    const permissionsInRoleClient = new AuthokRestClient(
    ...
    const usersInRoleClient = new AuthokRestClient(
