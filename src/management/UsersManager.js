...
class UsersManager {
  ...
  constructor(options) {
    ...
    const usersauthokRestClient = new AuthokRestClient(
      `${options.baseUrl}/users/:id`,
      clientOptions,
      options.tokenProvider
    );
    this.users = new RetryRestClient(usersauthokRestClient, options.retry);

    /**
     * Provides an abstraction layer for consuming the
     * {@link https://docs.authok.cn/api/v1#!/Users/delete_multifactor_by_provider
     * Multifactor Provider endpoint}.
     *
     * @type {external:RestClient}
     */
    const multifactorauthokRestClient = new AuthokRestClient(
      `${options.baseUrl}/users/:id/multifactor/:provider`,
      clientOptions,
      options.tokenProvider
    );
    this.multifactor = new RetryRestClient(multifactorauthokRestClient, options.retry);
     ...
     * @type {external:RestClient}
     */
    const identitiesauthokRestClient = new AuthokRestClient(
      `${options.baseUrl}/users/:id/identities/:provider/:user_id`,
      clientOptions,
      options.tokenProvider
    );
    this.identities = new RetryRestClient(identitiesauthokRestClient, options.retry);
     ...
     * @type {external:RestClient}
     */
    const userLogsauthokRestClient = new AuthokRestClient(
      `${options.baseUrl}/users/:id/logs`,
      clientOptions,
      options.tokenProvider
    );
    this.userLogs = new RetryRestClient(userLogsauthokRestClient, options.retry);
     ...
     * @type {external:RestClient}
     */
    const enrollmentsauthokRestClient = new AuthokRestClient(
      `${options.baseUrl}/users/:id/enrollments`,
      clientOptions,
      options.tokenProvider
    );
    this.enrollments = new RetryRestClient(enrollmentsauthokRestClient, options.retry);
     ...
     * @type {external:RestClient}
     */
    const usersByEmailClient = new AuthokRestClient(
     ...
     * @type {external:RestClient}
     */
    const recoveryCodeRegenerationauthokRestClients = new AuthokRestClient(
      `${options.baseUrl}/users/:id/recovery-code-regeneration`,
      clientOptions,
      options.tokenProvider
    );
    this.recoveryCodeRegenerations = new RetryRestClient(
      recoveryCodeRegenerationauthokRestClients,
      options.retry
    );
     ...
     * @type {external:RestClient}
     */
    const invalidateRememberBrowserauthokRestClients = new AuthokRestClient(
    ...
    this.invalidateRememberBrowsers = new RetryRestClient(
      invalidateRememberBrowserauthokRestClients,
      options.retry
    );
     ...
     * @type {external:RestClient}
     */
    const userRolesClient = new AuthokRestClient(
     ...
     * @type {external:RestClient}
     */
    const userPermissionsClient = new AuthokRestClient(
    ...
    const organizationsClient = new AuthokRestClient(
