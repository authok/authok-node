...
class JobsManager {
  ...
  constructor(options) {
     ...
     * {@link https://docs.authok.cn/api/v1#!/Jobs Jobs endpoint}.
     *
    ...
    this.jobs = new RetryRestClient(authokRestClient, options.retry);

    /**
     * Provides an abstraction layer for consuming the
     * {@link https://docs.authok.com/api/v1#!/Jobs/:id/errors Errors endpoint}.
     *
     * @type {external:RestClient}
     */
    const jobErrorsRestClient = new AuthokRestClient(
    ...
    /**
     * Provides an abstraction layer for consuming the
     * {@link https://docs.authok.cn/api/v1#!/Jobs/post_users_exports Create job to export users endpoint}
     *
     * @type {external:RestClient}
     */
    const usersExportsRestClient = new AuthokRestClient(
