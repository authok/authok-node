...
class ConnectionsManager {
  ...
  constructor(options) {
     ...
     * {@link https://docs.authok.cn/api/v1#!/ConnectionsManagers Authok
     *  Connections}.
     *
    ...
    const statusClient = new AuthokRestClient(
     ...
     * {@link https://docs.authok.cn/api/management/v1#!/Connections/delete_users_by_email
     * endpoint}.
     *
     * @type {external:RestClient}
     */
    const userauthokRestClient = new AuthokRestClient(
      `${options.baseUrl}/connections/:id/users`,
      clientOptions,
      options.tokenProvider
    );
    this.user = new RetryRestClient(userauthokRestClient, options.retry);
  }
