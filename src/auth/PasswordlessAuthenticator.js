...
class PasswordlessAuthenticator {
   ...
   *
   * https://authok.com/docs/api/authentication#authenticate-user
   * </caption>
   *
   * var data = {
   ...
   * };
   *
   * authok.passwordless.signIn(data, function (err) {
   *   if (err) {
   *     // Handle error.
   *   }
   * });
   ...
   *
   * https://authok.com/docs/api/authentication#resource-owner
   * </caption>
   *
   * var data = {
  ...
  signIn(userData, options, cb) {
    ...
    if (typeof data.otp === 'string' && data.otp.trim().length > 0) {
      ...
      data.grant_type = 'http://authok.com/oauth/grant-type/passwordless/otp';
   ...
   * };
   *
   * authok.passwordless.sendEmail(data, function (err) {
   *   if (err) {
   *     // Handle error.
   *   }
   * });
   ...
   * };
   *
   * authok.passwordless.sendSMS(data, function (err) {
   *   if (err) {
   *     // Handle error.
   *   }
   * });
