...
class DatabaseAuthenticator {
   ...
   *   object in the <a href="https://authok.com/docs/auth-api#!#post--oauth-ro">
   *   API docs</a>.
   * </caption>
   *
   * var data = {
   ...
   * };
   *
   * authok.database.signIn(data, function (err, userData) {
   *   if (err) {
   *     // Handle error.
   *   }
   *
   ...
   *   <a href="https://authok.com/docs/auth-api#!#post--dbconnections-signup">
   *   API Docs</a>.
   * </caption>
   *
   * var data = {
   ...
   * };
   *
   * authok.database.signUp(data, function (err, userData) {
   *   if (err) {
   *     // Handle error.
   *   }
   *
   ...
   * };
   *
   * authok.database.changePassword(data, function (err, message) {
   *   if (err) {
   *     // Handle error.
   *   }
   *
   ...
   * };
   *
   * authok.database.requestChangePasswordEmail(data, function (err, message) {
   *   if (err) {
   *     // Handle error.
   *   }
   *
