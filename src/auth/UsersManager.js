...
class UsersManager {
   ...
   * </caption>
   *
   * authok.users.getInfo(accessToken, function (err, userInfo) {
   *   if (err) {
   *     // Handle error.
   *   }
   *
   ...
   *   [API Docs](https://authok.com/docs/auth-api#!#post--users--user_id--impersonate).
   * </caption>
   *
   * var settings = {
   ...
   * };
   *
   * authok.users.impersonate(userId, settings, function (err, link) {
   *   if (err) {
   *     // Handle error.
   *   }
   *
