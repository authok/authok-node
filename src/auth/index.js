 ...
 *
 * This client must used to access Authok's {@link https://authok.com/docs/auth-api Authentication API}.
 *
 * @example <caption>
...
class AuthenticationClient {
  ...
  constructor(options) {
    ...
    if (options.telemetry !== false) {
      ...
      if ('string' === typeof clientInfo.name && clientInfo.name) {
        ...
        managerOptions.headers['Authok-Client'] = telemetry;
      }
    }
   ...
   *   <a href="https://authok.com/docs/auth-api#!#post--with_email">API Docs</a>
   * </caption>
   *
   * var data = {
   *   email: '{EMAIL}',
   ...
   * };
   *
   * authok.requestMagicLink(data, function (err) {
   *   if (err) {
   *     // Handle error.
   *   }
   * };
   ...
   * };
   *
   * authok.requestEmailCode(data, function (err) {
   *   if (err) {
   *     // Handle error.
   *   }
   * };
   ...
   * };
   *
   * authok.verifyEmailCode(data, function (err) {
   *   if (err) {
   *     // Handle error.
   *   }
   * });
   ...
   * };
   *
   * authok.requestSMSCode(data, function (err) {
   *   if (err) {
   *     // Handle error.
   *   }
   *
   ...
   * };
   *
   * authok.verifySMSCode(data, function (err) {
   *   if (err) {
   *     // Handle error.
   *   }
   * });
   ...
   *   <a href="https://authok.com/docs/auth-api#!#post--delegation">API Docs</a>.
   * </caption>
   *
   * var data = {
   *   id_token: '{ID_TOKEN}',
   ...
   * };
   *
   * authok.getDelegationToken(data, function (err, token) {
   *   if (err) {
   *     // Handle error.
   *   }
   *
   ...
   *   use, Authok will send a forgot password email. Once the user clicks on the
   ...
   *   <a href="https://authok.com/docs/auth-api#!#post--dbconnections-change_password">
   *   API Docs</a>.
   * </caption>
   *
   * var data = {
   ...
   * };
   *
   * authok.changePassword(data, function (err, message) {
   *   if (err) {
   *     // Handle error.
   *   }
   *
   ...
   *
   * @example <caption>
   *   Given the user email, the connection specified, Authok will send a change
   ...
   *   information in the <a href="https://authok.com/docs/auth-api#!#post--dbconnections-change_password>
   *   API Docs</a>.
   * </caption>
   *
   * var data = {
   ...
   * };
   *
   * authok.requestChangePasswordEmail(data, function (err, message) {
   *   if (err) {
   *     // Handle error.
   *   }
   *
   ...
   *
   * @example <caption>
   *   Get the user information based on the Authok access token (obtained during
   *   login). Find more information in the
   *   <a href="https://authok.com/docs/auth-api#!#get--userinfo">API Docs</a>.
   * </caption>
   *
   * authok.getProfile(data, function (err, userInfo) {
   *   if (err) {
   *     // Handle error.
   *   }
   *
   ...
   *   <a href="https://docs.authok.cn/api-auth/config/asking-for-access-tokens">API Docs</a>.
   * </caption>
   *
   ...
   * @param     {string}  [options.audience] audience or identifier of the API where the access token will be used, e.g. Authok Management API
   * @returns    {Promise|undefined}
   */
   ...
   *   <a href="https://authok.com/docs/api/authentication#resource-owner-password">
   *     API Docs
   *   </a>.
   * </caption>
   *
   ...
   * };
   *
   * authok.passwordGrant(data, function (err, userData) {
   *   if (err) {
   *     // Handle error.
   *   }
   *
   ...
   * @param   {string}    [options.forwardedFor] Value to be used for authok-forwarded-for header
   * @returns  {Promise|undefined}
   */
  passwordGrant(...args) {
   ...
   *   it will return a JSON with the access_token and id_token.
   *   More information in the
   *   <a href="https://authok.com/docs/api/authentication#refresh-token">
   *     API Docs
   *   </a>.
   * </caption>
   *
   ...
   * };
   *
   * authok.refreshToken(data, function (err, userData) {
   *   if (err) {
   *     // Handle error.
   *   }
   *
