...
class TokensManager {
   ...
   *   <a href="https://authok.com/docs/auth-api#!#post--tokeninfo">API Docs</a>.
   * </caption>
   *
   * authok.tokens.getInfo(token, function (err, tokenInfo) {
   *   if (err) {
   *     // Handle error.
   *   }
   *
   ...
   * };
   *
   * authok.tokens.getDelegationToken(data, function (err, token) {
   *   if (err) {
   *     // Handle error.
   *   }
   *
   ...
   * @param   {string}    data.api_type       The API to be used (aws, authok, etc).
   ...
   *   Find more information in the <a href="https://authok.com/docs/api/authentication#revoke-refresh-token">API Docs</a>.
   * </caption>
   *
   *  var data = {
   *   token: '{REFRESH_TOKEN}'
   * };
   *
   * authok.tokens.revokeRefreshToken(data, function (err, _) {
   *   if (err) {
   *     // Handle error.
   *   }
   *
